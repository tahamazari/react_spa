...
class FilmDetailModal extends Component {
    ...
    getAverage = (id, token) => {
        const outer_this = this
        fetch(`http://localhost:5000/api/ratings/average_rating/${id}`, { 
            method: 'get', 
            headers: new Headers({
              'Authorization': 'Bearer '+ token, 
            }), 
    ...
    editRateFilm = (id, token, rating, film_id) => {
        const outer_this = this
        fetch(`http://localhost:5000/api/ratings/update_ratings/${id}`, { 
            method: 'put', 
            headers: new Headers({
              'Authorization': 'Bearer '+ token, 
    ...
    RateFilm = (id, token, rating, film_id) => {
        const outer_this = this
        fetch(`http://localhost:5000/api/ratings/give_rating`, { 
            method: 'post', 
            headers: new Headers({
              'Authorization': 'Bearer '+ token, 
              "Content-Type": "application/json"
    ...
    editFilm(e){
        ...
        fetch(`http://localhost:5000/api/films/update/${this.props.id}`, { 
            method: 'put', 
            headers: new Headers({
