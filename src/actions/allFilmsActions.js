...
export const getFilms = (token) => dispatch => {
    fetch('https://react-spa-tintash.herokuapp.com/api/films', { 
        method: 'get', 
        headers: new Headers({
...
export const getRatings = (token) => dispatch => {
    fetch(`https://react-spa-tintash.herokuapp.com/api/ratings/average_ratings`, { 
        method: 'get', 
        headers: new Headers({
          'Authorization': 'Bearer '+ token, 
        }), 
...
export const addFilm = (token, data) => dispatch => {
    ...
    fetch("https://react-spa-tintash.herokuapp.com/api/films/create_film", { 
        method: 'post', 
        headers: new Headers({
          'Authorization': 'Bearer '+ token, 
...
export const filterSearch = (token, data) => dispatch => {
    fetch(`https://react-spa-tintash.herokuapp.com/api/films/filter/${data.minYear}/${data.maxYear}/${data.rating}`, { 
        method: 'get', 
        headers: new Headers({
          'Authorization': 'Bearer '+ token, 
        }), 
